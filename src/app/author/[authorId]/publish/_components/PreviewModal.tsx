...
const PreviewModal: React.FC<PreviewModalProps> = ({
  ...
  const overlayRef = useOutsideClick(onClose) as Ref<HTMLDivElement>

  return (
    <div className="fixed inset-0 bg-[#000000d7] bg-opacity-50 flex items-center justify-center z-50" ref={overlayRef}>
      <div className="bg-white rounded-lg p-8 w-[900px] max-w-[95vw] max-h-[90vh] overflow-auto no-scrollbar">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          <div className="w-80">
            <div className="border-2 border-dashed border-[#4BB1FF] bg-[#EDF7FF] rounded-lg p-6 text-center h-[350px] flex flex-col items-center justify-center">
              <div className=" rounded relative size-25 flex items-center justify-center mb-4">
                <Image src="/ebook1.svg" fill alt="Create E-Book" />
              </div>
            ...
            >
              <div className="relative size-5">
                ...
                <Image src="/play.svg" fill alt="Pricing" />
              </div>
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="bg-[#edf7ff] text-[#236fea] text-xs px-2 py-0.5 rounded-full flex items-center justify-center">
                <BadgeCheck size={24} className="mr-1" />
              </span>
            </div>
            ...
            <div className="mb-6 text-[#000B21] flex items-center space-x-4">
              ...
              <div className="flex items-center gap-2 ">
                <Image src="/coin2.svg" width={24} height={24} alt="Coin" className="size-6" />
                <span>193 STRK</span>
              </div>
            </div>
