        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="w-64 bg-white border-r border-[#e7e7e7] flex flex-col overflow-hidden">
            ...
            <div className="flex-1 overflow-auto">
              <ul className="py-2">
                {["Cover", "Praise", "Title", "Chapter 1", "How it Started", "Let Go", "Chapter 2", "How it started", "Where Are We"].map(el => <li key={el} className="px-4 py-2 hover:bg-[#f6f6f6] cursor-pointer">
                  {el}
                </li>)}
              </ul>
            </div>
