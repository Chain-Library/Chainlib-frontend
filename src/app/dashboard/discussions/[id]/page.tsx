...
export default function LiveEventPage() {
  return (
    <div className="flex flex-col items-start md:flex-row gap-x-10 p-4 md:max-w-8xl  ">
      <div className="">
 ...
 flex items-center gap-1"
      ...
      <div className="bg-white rounded-xl shadow p-4 w-full max-w-md mt-6">
        <h3 className="text-md font-semibold mb-2 text-gray-800">Live Chat</h3>
        <hr className="mb-4" />
