  ...
  return (
    <div className="w-full p-4 grid grid-cols-2 gap-4 sm:flex sm:flex-row sm:items-center sm:justify-between">
      <div className="flex items-center gap-x-8">
        <div
          className="bg-[#F6F6F6]  font-semibold rounded-full px-5 py-3 text-sm whitespace-nowrap col-span-2 sm:col-auto"
          aria-current="true"
        >
          <p> Clubs You've Joined (2)</p>
        </div>
        ...
        <button
          type="button"
          className="border border-gray-300 text-[#888888] flex items-center gap-x-1 rounded-lg px-2 py-3 text-sm font-medium  whitespace-nowrap hover:bg-gray-100 transition"
        >
          <span>
