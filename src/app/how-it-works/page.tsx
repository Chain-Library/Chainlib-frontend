...
export default function Page() {
    ...
    return (
        <>
            ...
            <header className="px-6 lg:px-15 mt-54 sm:mt-40 lg:mt-54 mb-35 sm:mb-28 lg:mb-35 flex gap-14 xl:gap-32 justify-center md:items-center w-full flex-col xl:flex-row">
