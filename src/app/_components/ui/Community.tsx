...
export default function CommunitySection() {
  ...
  return (
    <section className="rounded-large w-full px-6 md:px-13 p-6 flex mx-auto flex-col md:flex-row justify-between items-center gap-10 max-w-5xl xl:max-w-6xl mt-10">
      ...
      <motion.div
        className="size-full h-full md:w-1/2"
      ...
      >
        ...
        >
          <Image
            ...
            width={300}
            height={300}
            className="rounded-small size-full object-cover  md:size-[100%]"
          />
        </motion.div>
      </motion.div>
    </section>
