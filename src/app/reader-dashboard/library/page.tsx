...
import { Search, ChevronDown, BookOpen, Users, Bookmark, CheckCircle, Clock, Eye } from "lucide-react"
      ...
      <div className="max-w-7xl mx-auto p-4 md:p-6 lg:p-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-semibold text-gray-900">Recently Purchased</h2>
            <button className="text-gray-500 hover:text-gray-700 text-sm font-medium border rounded-full py-3 px-5">View All →</button>
          </div>
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-semibold text-gray-900">Regular Books</h2>
            <button className="text-gray-500 hover:text-gray-700 text-sm font-medium border rounded-full py-3 px-5">View All →</button>
          </div>
                      ...
                      <div className="flex items-center gap-3 text-sm text-gray-500">
                        ...
                        <div className="flex items-center gap-1">
                          <div className="w-4 h-4 bg-red-500 rounded-full flex items-center justify-center">
                            <span className="text-white text-xs">{collection.owners}</span>
                          </div>
                          <span>Owners</span>
                        </div>
                      </div>
        ...
        {/* Book Modal */}
        {isModalOpen && selectedBook && <BookModal book={selectedBook} onClose={closeBookModal} />}
      </div>
    </div>
  )
}
