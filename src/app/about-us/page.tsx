import CommunitySection from '@/app/_components/ui/Community';
...
export default function page() {
    return (
        <>
            <Navbar />
            <main className="flex-grow mt-30 sm:mt-15 lg:mt-30 md:pb-15">
                {/* Hero Section */}
                ...
                {/* What is Chainlib */}
                <section className="px-6 md:px-15 max-w-6xl mx-auto py-12">
                ...
                <section className="py-16 px-6 md:px-15 max-w-6xl mx-auto flex flex-col md:flex-row">
