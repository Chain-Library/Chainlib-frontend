...
export default function page() {
    return (
        <>
            <Navbar />
            <main className="flex-grow mt-30 sm:mt-15 lg:mt-30">
                {/* Hero Section */}

                <div className=" overflow-hidden px-6 md:px-15 max-w-7xl mx-auto text-center py-16 md:py-20">
                ...
                {/* People Banner */}
                <div className="w-full mx-auto relative mb-16 md:mb-20 h-24 md:h-46">
                    <Image
                        src={Image2}
                ...
                {/* What is Chainlib */}
                <section className="px-6 md:px-15 max-w-7xl mx-auto py-12">
                ...
                <section className="py-16 px-6 md:px-15 max-w-7xl mx-auto flex flex-col md:flex-row">
                ...
                {/* Join Our Community */}
                <section className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center max-w-5xl mx-auto px-6 md:px-15 py-16">
                    <div>
