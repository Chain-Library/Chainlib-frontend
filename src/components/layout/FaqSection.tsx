...
export default function FaqSection() {
    ...
    return (
        <div className="w-4xl mx-auto">
            <h2 className="text-primary-950 text-center font-bold text-headline-xl-large">
                You Got Questions?
            </h2>
    ...
    return (
        <div className="border-b-[0.5px] border-neutral-200 text-neutral-600 py-5 px-4 flex flex-col justify-center items-start font-light w-full relative overflow-hidden">
            <h3 onClick={() => {
                ...
                <span className="text-title-large text-neutral-900">
                    {question}
                </span>
                <span
            ...
            <p className={`text-body-18px-large max-w-[46rem] overflow-hidden transition-all duration-300 ease-in-out ${clicked === index ? "h-auto mt-8" : "h-0 max-h-0"}`}>
                {answer}
            </p>
        </div >
    )
