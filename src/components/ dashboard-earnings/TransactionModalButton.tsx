...
const transactionDetails = [
  ...
  {
    heading: "Status",
    value: <span className=" bg-[#34A8531A] border-[0.5px] border-[#34A853] py-1 px-2 rounded-[12px]  " >Successful</span>,
  },
    {
    heading: "Date",
    value: "12 March, 2025 ",
...
export default function TransactionModalButton() {
  ...
  return (
      ...
      >
        <Box sx={style}>
          <div className="w-full h-full flex flex-col gap-6 items-start">
            ...
            <Stack className="w-full border-[1px] border-[#E7E7E7] rounded-lg " p={"24px"} direction={"row"} alignItems={"center"} spacing={1}   >
              <Box className="basis-1/2 flex items-center gap-6 justify-start " >
                ...
                <Box>
                  <h1 className="text-[#454545] text-base font-bold mb-2 "> 99 Laws of Power </h1>
              ...
              <hr className="w-[1px] h-[117px] bg-[#E7E7E7]  " />
   ...
   <Box className="basis-1/2  space-y-5 pr-3 ">
 ...
 <hr className="w-[1px] h-[168px] bg-[#E7E7E7] " />


              <Box className="basis-1/2  space-y-5  pl-3  ">
                {NFTdetails.map((item, index) => (
                  <Stack className="w-full px-[4px] " key={index} justifyContent="space-between" direction={"row"} alignItems={"center"} spacing={3} >
                    <h3 className="text-[#5D5D5D] text-sm font-normal flex items-center gap-1 " >    {item.heading} </h3>
                    <h4 className="text-base text-[#454545] font-normal flex items-center gap-1" > {item.value} STRK </h4></Stack>
                ))}
              </Box>
            ...
            <div className="w-full flex items-start gap-8">
              <Stack className="w-full" direction="row" alignItems="center" spacing={3} p={0} useFlexGap>
                ...
                <Button variant="outlined"
                  ...
                  className="basis-1/2">Back</Button>

                <Button
                  variant="contained"
                  className="basis-1/2 bg-[linear-gradient(179.56deg,_#EDF7FF_60.22%,_#096CFF_317.32%)]"
                  disableElevation
                  disableRipple
                  sx={{ color: "#0F265C", fontWeight: "400", fontSize: "14px", textTransform: 'none', }}
