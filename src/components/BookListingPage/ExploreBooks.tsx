...
export default function ExploreBooks() {
    ...
    return (
        <section className=" w-full flex flex-col items-start justify-start gap-7  " >
            ...
            <div className="block"  >
                <h2 className="text-[#0F265C] font-bold  text-2xl  md:text-[32px] " >Explore Books</h2>
                <p className=" text-[#3D3D3D] text-lg font-normal " >Browse diverse genres, discover hidden gems, and find your next great read.</p>
            </div>
