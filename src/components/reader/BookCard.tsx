...
function BookCard({bookData} : BookCardProps ){
    ...
    return(
        <div className="bg-[#F6F6F6] w-[330px] h-[379px] rounded-lg pt-8 pb-6 px-6 flex flex-col gap-10 items-start justify-start "  >
...
<div className=" py-2 px-3 w-full flex flex-col gap-[14px] items-start   "  >
   ...
   <p className=" text-[#5D5D5D] text-sm font-normal flex items-center gap-2 " ><span>By {bookData.author}  </span><VerifiedIcon/> </p></div>
